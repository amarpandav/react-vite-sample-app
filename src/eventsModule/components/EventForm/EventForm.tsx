...
import {throwError} from "../../../homeModule/components/Error/RouteErrorPage.tsx";
import {formatToISODate} from "../../../utils/dateUtils.ts";
        ...
        <Form method={method}/*method='post'*/ /*action='any-other-action-than-currently-active-route-optional'*/ className={classes.form}>
          ...
          */}
                <input id="date" type="date" name="eventDate" required
                       defaultValue={eventDto ? formatToISODate(eventDto.eventDate) : '2024-05-15'}/>
            </p>
            <p>
