    ...
    useEffect(() => {
        async function fetchEvents() {
            ...
            if (!response.ok) {
                ...
                //When using useEffect(), throwing an error like throw new Response(...) won't trigger React Router's error handling
                //because it's not part of a loader. Instead, you need to handle the error inside your component and manually
